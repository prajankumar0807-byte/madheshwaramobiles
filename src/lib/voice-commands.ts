...
export const COMMANDS: Command[] = [
  ...
  { id: "services", kind: "navigate", section: "services",
    ...
    keywords: ["service", "services", "repair", "fix", "display", "mic", "screen",
      "charging port", "battery replacement", "replace battery", "battery repair",
      "சேவை", "பழுது", "ரிப்பேர்", "டிஸ்ப்ளே", "மைக்", "பேட்டரி மாற்றம்", "பேட்டரி பழுது"] },
  ...
  { id: "call", kind: "call", url: URLS.tel,
    ...
    keywords: ["call", "phone", "dial", "ring", "call the shop", "call shop", "phone the shop",
      "அழை", "கால்", "போன்", "கடையை அழை", "கடைக்கு அழை"] },
